...
# Initialize Firebase Admin (do this once, e.g., in settings or a separate module)
if not firebase_admin._apps:
    cred = credentials.Certificate("myapp/Dso.json")  # Update this with your actual path
